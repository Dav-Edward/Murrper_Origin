execute at @s anchored eyes positioned ^ ^-1 ^4 if entity @e[type=!player,distance=..5.0,sort=nearest,limit=1,nbt={DeathTime:0s}] run summon minecraft:experience_orb ^ ^ ^-3 {Tags:["fd_energy_orb_turret"],NoGravity:1,NoAI:1,Health:1f,Attributes:[{Base:1.0d,Name:"minecraft:generic.max_health"}],Slient:1,Age:5990,ActiveEffects:[{Id:14,Amplifier:1b,Duration:999999,ShowParticles:0b}]}

execute as @e[tag=fd_energy_orb_turret,distance=..5,limit=1,sort=nearest] if entity @s at @s if entity @e[type=!player,distance=..10.0,sort=nearest,limit=1,nbt={DeathTime:0s}] if entity @s run tp @s ~ ~ ~ facing entity @e[type=!player,distance=..10.0,sort=nearest,limit=1,nbt={DeathTime:0s}]

execute if entity @p[distance=..3.0,limit=1,sort=nearest,nbt={cardinal_components:{"apoli:powers":{"Powers":[{Type:"davwyndragon:energyorb_turret_ammo",Data:5}]}}}] at @s anchored eyes positioned ^ ^-1 ^4 as @e[type=!player,distance=..5.0,sort=nearest,limit=1,nbt={DeathTime:0s}] if entity @s at @s run summon minecraft:experience_orb ~ ~0.5 ~ {Value:1}

execute as @p[distance=..3.0,limit=1,sort=nearest,nbt={cardinal_components:{"apoli:powers":{"Powers":[{Type:"davwyndragon:energyorb_turret_ammo"}]}}}] if entity @s if entity @e[tag=fd_energy_orb_turret,distance=..5,limit=1,sort=nearest] if entity @s at @s if entity @e[type=!player,distance=..5.0,sort=nearest,limit=1,nbt={DeathTime:0s}] run resource change @s davwyndragon:energyorb_turret_ammo -1
...
execute at @s anchored eyes positioned ^ ^-1 ^4 as @e[type=!player,distance=..5.0,sort=nearest,limit=1,nbt={DeathTime:0s}] if entity @s at @s if entity @e[type=player,sort=nearest,limit=1,distance=..30,nbt={DeathTime:0s}] run data modify entity @s AngryAt set from entity @e[type=player,sort=nearest,limit=1,distance=..30,nbt={DeathTime:0s}] UUID
execute at @s anchored eyes positioned ^ ^-1 ^4 as @e[type=!player,distance=..5.0,sort=nearest,limit=1,nbt={DeathTime:0s}] if entity @s at @s if entity @e[type=player,sort=nearest,limit=1,distance=..30,nbt={DeathTime:0s}] run data modify entity @s AngryTime set value 10

execute at @s anchored eyes positioned ^ ^-1 ^4 as @e[type=!player,distance=..5.0,sort=nearest,limit=1,nbt={DeathTime:0s}] if entity @s at @s run particle minecraft:large_smoke ~ ~0.5 ~ 0.5 0.5 0.5 0.05 10 force
execute at @s anchored eyes positioned ^ ^-1 ^4 as @e[type=!player,distance=..5.0,sort=nearest,limit=1,nbt={DeathTime:0s}] if entity @s at @s run particle minecraft:end_rod ~ ~0.5 ~ 0.5 0.5 0.5 0.05 10 force
execute at @s anchored eyes positioned ^ ^-1 ^4 as @e[type=!player,distance=..5.0,sort=nearest,limit=1,nbt={DeathTime:0s}] if entity @s at @s run particle minecraft:flash ~ ~0.5 ~ 0.5 0.5 0.5 0.0 2 force
execute at @s anchored eyes positioned ^ ^-1 ^4 as @e[type=!player,distance=..5.0,sort=nearest,limit=1,nbt={DeathTime:0s}] if entity @s at @s run particle minecraft:flame ~ ~0.5 ~ 0.5 0.5 0.5 0.02 10 force
execute at @s anchored eyes positioned ^ ^-1 ^4 as @e[type=!player,distance=..5.0,sort=nearest,limit=1,nbt={DeathTime:0s}] if entity @s at @s run playsound minecraft:item.trident.hit player @a[distance=..20] ~ ~ ~ 2
execute at @s anchored eyes positioned ^ ^-1 ^4 as @e[type=!player,distance=..5.0,sort=nearest,limit=1,nbt={DeathTime:0s}] if entity @s at @s run playsound minecraft:item.trident.hit_ground player @a[distance=..20] ~ ~ ~ 2
execute at @s anchored eyes positioned ^ ^-1 ^4 as @e[type=!player,distance=..5.0,sort=nearest,limit=1,nbt={DeathTime:0s}] if entity @s at @s run playsound minecraft:entity.firework_rocket.blast player @a[distance=..20] ~ ~ ~ 2
execute at @s anchored eyes positioned ^ ^-1 ^4 as @e[type=!player,distance=..5.0,sort=nearest,limit=1,nbt={DeathTime:0s}] if entity @s at @s run data modify entity @e[type=!player,distance=..3.0,sort=nearest,limit=1,nbt={DeathTime:0s}] Fire set value 30s
execute at @s anchored eyes positioned ^ ^-1 ^4 as @e[type=!player,distance=..5.0,sort=nearest,limit=1,nbt={DeathTime:0s}] if entity @s at @s run power grant @s davwyndragon:entity_damage_3
