...
execute if entity @s[y_rotation=-22..22] at @s positioned ^ ^1 ^1 as @e[type=!player,distance=..5.0,sort=nearest,nbt={DeathTime:0s}] if entity @s at @s run tag @s add dragon_push_upup_forward_1
execute if entity @s[y_rotation=23..67] at @s positioned ^ ^1 ^1 as @e[type=!player,distance=..5.0,sort=nearest,nbt={DeathTime:0s}] if entity @s at @s run tag @s add dragon_push_upup_forward_2
execute if entity @s[y_rotation=68..112] at @s positioned ^ ^1 ^1 as @e[type=!player,distance=..5.0,sort=nearest,nbt={DeathTime:0s}] if entity @s at @s run tag @s add dragon_push_upup_forward_3
execute if entity @s[y_rotation=113..157] at @s positioned ^ ^1 ^1 as @e[type=!player,distance=..5.0,sort=nearest,nbt={DeathTime:0s}] if entity @s at @s run tag @s add dragon_push_upup_forward_4
execute if entity @s[y_rotation=158..180] at @s positioned ^ ^1 ^1 as @e[type=!player,distance=..5.0,sort=nearest,nbt={DeathTime:0s}] if entity @s at @s run tag @s add dragon_push_upup_forward_5
execute if entity @s[y_rotation=-180..-158] at @s positioned ^ ^1 ^1 as @e[type=!player,distance=..5.0,sort=nearest,nbt={DeathTime:0s}] if entity @s at @s run tag @s add dragon_push_upup_forward_5
execute if entity @s[y_rotation=-157..-113] at @s positioned ^ ^1 ^1 as @e[type=!player,distance=..5.0,sort=nearest,nbt={DeathTime:0s}] if entity @s at @s run tag @s add dragon_push_upup_forward_6
execute if entity @s[y_rotation=-112..-68] at @s positioned ^ ^1 ^1 as @e[type=!player,distance=..5.0,sort=nearest,nbt={DeathTime:0s}] if entity @s at @s run tag @s add dragon_push_upup_forward_7
execute if entity @s[y_rotation=-67..-23] at @s positioned ^ ^1 ^1 as @e[type=!player,distance=..5.0,sort=nearest,nbt={DeathTime:0s}] if entity @s at @s run tag @s add dragon_push_upup_forward_8
execute at @s positioned ^ ^1 ^1 as @e[type=!player,distance=..5.0,sort=nearest,nbt={DeathTime:0s}] if entity @s at @s as @p run schedule function davwyndragon:dragon_push_upup_forward 2t